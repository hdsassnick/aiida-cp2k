...
def parse_cp2k_output(fstring, sections):  # pylint: disable=too-many-locals, too-many-statements, too-many-branches
    ...
    for i_line, line in enumerate(lines):
        ...
        #  Base output that is parsed and stored regardless of the parser type.
        #  Program version and calculation type
